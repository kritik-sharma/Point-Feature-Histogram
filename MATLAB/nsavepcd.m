...
%
% NSAVEPCD(FNAME, P) writes the point cloud P to the file FNAME as an
% as a PCD format file.
%
% NSAVEPCD(FNAME, P, 'binary') as above but save in binary format.  Default
% is ascii format.
%
...
function nsavepcd(fname, points, binmode)
